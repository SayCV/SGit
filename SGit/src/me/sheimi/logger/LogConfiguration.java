...
public final class LogConfiguration {
    ...
    private static String mLogFileName = "myapp.log";
    ...
    public LogConfiguration(final String loggerName, final String fileName,
		...
		public static void InitDefault(final String loggerName, final String fileName) {
    		// Start log to file from here
        LogConfiguration.getInstance().setLoggerName(loggerName);
        LogConfiguration.getInstance().setFileName(fileName);
